...
The data ocean/lake solution is developed with Node.js for the microservices that run in AWS Lambda and Angular 1.x for the console user interface. The latest version of the data ocean/lake solution has been tested with Node.js v12.x.

#### 02. Build the data ocean/lake solution
Clone the pharmaceutical-data-ocean-aws GitHub repository:

```
git clone https://github.com/deamoner/pharmaceutical-data-ocean-aws.git
```
...
#### 04. Run the data ocean/lake solution unit tests:
```
cd ./pharmaceutical-data-ocean-aws/deployment
chmod +x run-unit-tests.sh
./run-unit-tests.sh
```

#### 05. Build the data ocean/lake solution for deployment:
```
...
#### 07. Deploy the data ocean/lake solution:
...
* Using AWS CloudFormation, launch the data ocean/lake solution stack using the copied Amazon S3 link for the data-lake-deploy.template or data-lake-deploy-federated.template.

> Currently, the data ocean/lake solution can be deployed in the following regions: [ us-east-1, us-east-2, us-west-2, eu-west-1, eu-west-2, eu-central-1, ap-northeast-1, ap-northeast-2, ap-southeast-2, ap-south-1 ]
